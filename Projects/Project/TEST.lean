...
/-
  ...
  "I pray to the aesop solver daily."
  "The types haunt me in my sleep."
  "Humanity shall be freed from the shackles of informality soon."
  "Lean compiles while sanity fades."
